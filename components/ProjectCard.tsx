...
export const ProjectCard: React.FC<ProjectCardProps> = ({ data, details, buttonText }) => {
  ...
  return (
    <div 
      ...
      role="link"
      tabIndex={0}
      className="group relative bg-white dark:bg-gray-800 rounded-2xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-500 transform hover:scale-[1.02] border border-gray-100 dark:border-gray-700 flex flex-col h-full cursor-pointer focus:outline-none focus:ring-2 focus:ring-primary-500"
    >
      {/* Image Container */}
